	...
	<div class="container">
		...
		<div class="editContent">
			<ul class="filter">
				...
				<li><a href="#" data-filter=".artwork">Empresa 01</a></li>
				<li><a href="#" data-filter=".creative">Empresa 02</a></li>
				<li><a href="#" data-filter=".nature">Empresa 03</a></li>
				<li><a href="#" data-filter=".outside">Empresa 04</a></li>
				<li><a href="#" data-filter=".photography">Empresa 05</a></li>
			</ul>
		</div>
		<!-- /.gallery-filter -->
