		...
		<div class="row">
			<div class="col-md-3 col-sm-3">
				<div class="widget">
					...
					<address>
						<strong>Edifício West Center</strong><br>
						R. Padre Anchieta, 2454 - Cj. 903<br>
						Bigorrilho - Curitiba - Paraná</address>
					<p>
						<i class="icon-phone"></i> +55 41 3155-5850 <br>
						<i class="icon-envelope-alt"></i> <a href="mailto:contato@4results.com.br" style="color: #fff;">contato@4results.com.br</a>
					</p>
				</div>
			</div>
			<div class="col-md-3 col-sm-3">
				<div class="widget">
					<h5 class="widgetheading">Links Rápidos</h5>
					<ul class="link-list">
						<li><a href="=events.php">Ultimos eventos</a></li>
			...
			<div class="col-md-3 col-sm-3">
				<div class="widget">
					<h5 class="widgetheading">Noticias Recentes</h5>
					<ul class="link-list">
						<li><a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a></li>
						<li><a href="#">Pellentesque et pulvinar enim. Quisque at tempor ligula</a></li>
						<li><a href="#">Natus error sit voluptatem accusantium doloremque</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="copyright">
						<p>
							Copyright © 2019. Todos os direitos reservados. <br />Soluções para </span><a href="quemsomos.html" target="_blank">4Results</a>
						</p>
					</div>
				</div>
				<div class="col-lg-6">
